...
result <- read.csv('Masters Results 2016 - Sheet1.csv')
...
data_2016 <- data_2016[!is.na(data_2016$POS),] # only take players who participated in Masters
y_2016 <- as.vector(data_2016$POS)
